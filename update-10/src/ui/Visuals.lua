...
function Visuals.drawPromotionPopup()
    -- overlay the promotion UI if needed
    ...
    -- draw buttons
    love.graphics.setColor(1, 1, 1, 1)
    local opts = Helpers.promotionRequest.options
    ...
    for i, choice in ipairs(opts) do
        ...
        love.graphics.rectangle("line", bx, startY, btnW, btnH)
        love.graphics.printf(
            choice,
            bx, startY + btnH/2 - smallFont:getHeight()/2,
            btnW, "center"
        )
        end
    end
